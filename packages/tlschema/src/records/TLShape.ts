...
/** @public */
export type TLShapeProps = Expand<UnionToIntersection<TLDefaultShape['props']>>
...
/** @internal */
export function createShapeRecordType(shapes: Record<string, SchemaWithPropsInfo>) {
